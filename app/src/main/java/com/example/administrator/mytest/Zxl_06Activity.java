 ...
 */
public class Zxl_06Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zxl_06layout);
...
//                tv.setText(operaName[groupPosition]);
                LayoutInflater li = LayoutInflater.from(Zxl_06Activity.this);
            ...
            public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
                TextView tv = new TextView(Zxl_06Activity.this);
