...
import com.example.administrator.mytest.bean.CityPhone;
 ...
 */
public class Zxl_04Acticity extends Activity {
    ...
    Handler h = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            Gson gson = new Gson();
            CityPhone pc = gson.fromJson(str,CityPhone.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zxl_04layout);
